 ...
 */
final class Version20230202122815 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE songs ADD nb_chords_chorus INT NOT NULL, ADD nb_chords_verse INT NOT NULL, DROP chord_verse9_id, DROP chord_verse9_name');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE songs ADD chord_verse9_id INT DEFAULT NULL, ADD chord_verse9_name VARCHAR(255) DEFAULT NULL, DROP nb_chords_chorus, DROP nb_chords_verse');
